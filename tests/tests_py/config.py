...
def load_config() -> Config:
    ...
    ssh_port: int = int(os.environ.get("SSH_PORT", SSH_PORT_DEFAULT))
    ssh_strict_env: str = os.environ.get("SSH_STRICT", SSH_STRICT_DEFAULT)
    ssh_strict_bool: bool = (ssh_strict_env.lower() in ["yes", "true", "1"])
    ...
    return Config(
        ...
        ssh_strict_bool=ssh_strict_bool,
...
def load_config_from_env() -> Config:
    ...
    ssh_strict: bool = (ssh_strict_env.lower() in ["yes", "true", "1"])
